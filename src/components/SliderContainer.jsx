...
const SliderContainer = ({movies}) => {
    ...
    return (
        <SliderWrapper>
            ...
            <MovieSlider data={getMoviesBetween(40, 50)} title="Comedy" />
            <MovieSlider data={getMoviesBetween(50, 60)} title="Action" />
            <MovieSlider data={getMoviesBetween(60, 70)} title="Romantic" />
            <MovieSlider data={getMoviesBetween(70, 80)} title="Blockbusters" />
        </SliderWrapper>
    );
}
